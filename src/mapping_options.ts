...
export class MappingOptionsCtrl {
  ...
  constructor($scope) {
    ...
    this.colorOn = [{ text: 'Never', value: 'n' }, { text: 'Warning / Critical', value: 'wc' }, { text: 'Always', value: 'a' }];
    ...
    this.textReplace = [{ text: 'All content', value: 'content' }, { text: 'Substring', value: 'pattern' }];
    this.propTypes = [
      { text: 'Id', value: 'id' },
      // { text: "Value", value: "value" }
    ];
    this.textPattern = '/.*/';
    this.metricTypes = [{ text: 'Number', value: 'number' }, { text: 'String', value: 'string' }, { text: 'Date', value: 'date' }];
    this.dateFormats = [
